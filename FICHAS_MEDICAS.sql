...
CREATE TABLE `roles` (
  ...
  CONSTRAINT `roles_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`username`)
...
INSERT INTO `roles` VALUES (1,'DESARROLLADOR','DESO24','A'),(4,'DIRECTOR PROYECTO','DESO02','A');
...
INSERT INTO `usuario` VALUES ('DESO02','1234','JOSE LUIS','ROMERO','j.romero@cbecheverria.edu.ec',1,'DES002','A'),('DESO24','1234','JOSE LUIS','TAPIA','j.tapia@cbecheverria.edu.ec',1,'DESO24','A');
...
-- Dump completed on 2024-12-01 13:46:26
