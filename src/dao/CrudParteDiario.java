...
public class CrudParteDiario implements Parte_diarioDAO {
    ...
    @Override
    public boolean save(Parte_diario obj) {
    ...
    @Override
    public boolean update(Parte_diario obj) {
    ...
    public boolean delete(Integer idParte) {
        var query = "UPDATE parte_diario SET estado = ? WHERE id_partediario = ?";
    ...
    @Override
    public Parte_diario getOne(Integer idParte) {
        Parte_diario obj = null;
    ...
    public Integer getId(String name) {
        ...
        try (Connection conect = this.conexion.conectar(base); PreparedStatement st = conect.prepareStatement(query)) {
            ...
            if (rs.next()) {
                return rs.getInt("id_partediario");
            }
        } catch (SQLException ex) {
            Logger.getLogger(CrudParteDiario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Override
    public List<Parte_diario> getAll() {
        List<Parte_diario> datos = new ArrayList<>();
